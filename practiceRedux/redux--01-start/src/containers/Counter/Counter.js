...
const mapDispatchToProps = dispatch => {
  return {
    ...
    onIncrementDecrementer: () => dispatch({type: actionTypes.DECREMENT}),
    onIncrementAddFive: () => dispatch({type: actionTypes.ADD, val: 10}),
    onDecrementFive: () => dispatch({type: actionTypes.SUBTRACT, val: 15}),
